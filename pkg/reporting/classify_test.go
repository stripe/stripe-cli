...
func TestClassifyError(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "API rate limited", err: requests.RequestError{StatusCode: 429}, expected: errorcategory.RateLimit},
		{name: "API rate limited pointer", err: &requests.RequestError{StatusCode: 429}, expected: errorcategory.RateLimit},
		{name: "wrapped rate limited", err: fmt.Errorf("outer: %w", requests.RequestError{StatusCode: 429}), expected: errorcategory.RateLimit},
