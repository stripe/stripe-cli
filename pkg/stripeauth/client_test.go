...
func TestAuthorize(t *testing.T) {
	...
	session, err := client.Authorize(stripe.GetTestContext(), "my-device", "webhooks", nil, nil)
	require.NoError(t, err)
...
func TestUserAgent(t *testing.T) {
	...
	client.Authorize(stripe.GetTestContext(), "my-device", "webhooks", nil, nil)
}
...
func TestAuthorizeWithURLDeviceMap(t *testing.T) {
	...
	client.Authorize(stripe.GetTestContext(), "my-device", "webhooks", nil, &devURLMap)
}
