...
func DeployGuidedAction() *coop.GuidedAction {
	return &coop.GuidedAction{
		...
		Steps: []coop.SessionStep{
			{
				BlueprintStepDefinition: step("detect-deploy-path", "Detect deploy path"),
			...
			{
				BlueprintStepDefinition: step("configure-deploy", "Configure deployment"),
				Nodes: []coop.SessionNode{
			...
			{
				BlueprintStepDefinition: step("deploy", "Deploy"),
				Nodes: []coop.SessionNode{
			...
			{
				BlueprintStepDefinition: step("verify-deployment", "Verify deployment"),
				Nodes: []coop.SessionNode{
...
func DeployUpdateGuidedAction(target string) *coop.GuidedAction {
	...
	return &coop.GuidedAction{
		...
		Steps: []coop.SessionStep{
			{
				BlueprintStepDefinition: step("confirm-target", "Confirm deployment target"),
				Nodes: []coop.SessionNode{
			...
			{
				BlueprintStepDefinition: step("push-deploy", "Push deployment"),
				Nodes: []coop.SessionNode{
...
func step(key, title string) coop.BlueprintStepDefinition {
	return coop.BlueprintStepDefinition{
		Key:   key,
