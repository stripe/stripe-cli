			...
			Steps: []coop.SessionStep{
				{
					...
					Nodes: []coop.SessionNode{
						{Key: "n1", Title: "Create product", State: coop.NodeDone, Type: coop.NodeAPIRequest,
						...
						{Key: "n2", Title: "Create checkout", State: coop.NodeActive, Type: coop.NodeAPIRequest,
				...
				},
				{
					...
					Nodes: []coop.SessionNode{
						{Key: "n3", Title: "Handle event", State: coop.NodePending, Type: coop.NodeAsyncHandler,
	...
	m.session.Steps = []coop.SessionStep{
		{
			...
			Nodes: []coop.SessionNode{
				{Title: "Understand project", State: coop.NodeDone},
			},
		},
		{
			...
			Nodes: []coop.SessionNode{
				{Title: "Required", State: coop.NodeDone},
				{Title: "Optional", State: coop.NodeSkipped},
			},
		},
		{
			Key:   "incomplete",
			...
			Nodes: []coop.SessionNode{
				{Title: "Done", State: coop.NodeDone},
				{Title: "Still active", State: coop.NodeActive},
			},
		},
	}
	...
	m.session.Steps = []coop.SessionStep{
		{
			...
			Title: "Checks",
			Nodes: []coop.SessionNode{
				{Title: "First", State: coop.NodeDone, ReviewPrompt: "Check one"},
				{Title: "Duplicate", State: coop.NodeDone, ReviewPrompt: "Check one"},
				{Title: "Active", State: coop.NodeActive, ReviewPrompt: "Do not include active"},
				{Title: "Second", State: coop.NodeDone, ReviewPrompt: "Check two"},
				{Title: "Third", State: coop.NodeDone, ReviewPrompt: "Check three"},
				{Title: "Fourth", State: coop.NodeDone, ReviewPrompt: "Check four"},
				{Title: "Fifth", State: coop.NodeDone, ReviewPrompt: "Do not include after cap"},
			},
		},
	}
...
func TestAnnotationWrapsAtNarrowWidth(t *testing.T) {
	...
	node := coop.SessionNode{
		Key: "test", Title: "Step", State: coop.NodeActive,
...
func TestRenderStepLineSkipped(t *testing.T) {
	m := testModel()
	node := coop.SessionNode{
		Key: "skipped", Title: "Skipped step", State: coop.NodeSkipped,
...
func TestViewportShowsMoreBelowIndicator(t *testing.T) {
	...
	m.session.Steps = []coop.SessionStep{{
		...
		Title: "Long step",
		Nodes: []coop.SessionNode{
			{Title: "One", State: coop.NodeDone},
			{Title: "Two", State: coop.NodeDone},
			{Title: "Three", State: coop.NodeDone},
			{Title: "Four", State: coop.NodeDone},
			{Title: "Five", State: coop.NodeDone},
			{Title: "Six", State: coop.NodeDone},
		},
	}}
	m.cursor = 0
	m.resizeViewport()
