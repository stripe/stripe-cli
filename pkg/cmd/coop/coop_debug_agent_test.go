	...
	store, session := setupDebugAgentSession(t, []coop.SessionStep{
		{
			...
			Nodes: []coop.SessionNode{
				{Key: "checkout", Title: "Build Checkout", State: coop.NodePending, Type: coop.NodeAPIRequest},
			},
		},
	})
	...
	store, session := setupDebugAgentSession(t, []coop.SessionStep{
		{
			...
			Title: "Step",
			Nodes: []coop.SessionNode{
				{Key: "product", Title: "Create product", State: coop.NodePending, Type: coop.NodeAPIRequest},
				{Key: "checkout", Title: "Build Checkout", State: coop.NodePending, Type: coop.NodeAPIRequest},
			},
		},
	})
