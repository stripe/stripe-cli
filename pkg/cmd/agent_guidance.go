...
func newAgentGuidanceCmd(cfg *config.Config) *cobra.Command {
	agentGuidanceCmd := &cobra.Command{
		Use:   "agent-guidance",
	...
	agentGuidanceCmd.AddCommand(&cobra.Command{
		Use:   "snooze",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Fprintln(cmd.OutOrStdout(), "✔ Agent guidance snoozed for the rest of today.")
			return nil
		},
	})

	return agentGuidanceCmd
}
