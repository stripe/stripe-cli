...
const file_pkg_plugins_proto_main_proto_rawDesc = "" +
	...
	"\blivemode\x18\x03 \x01(\bR\blivemode2\xd8\x01\n" +
	"\x04Main\x12A\n" +
	"\n" +
	...
	"\fPreUninstall\x12\x1a.proto.PreUninstallRequest\x1a\x1b.proto.PreUninstallResponse2\xaa\x06\n" +
	"\rCoreCLIHelper\x12/\n" +
...
var file_pkg_plugins_proto_main_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
...
var file_pkg_plugins_proto_main_proto_depIdxs = []int32{
	...
	1,  // 17: proto.Main.RunCommand:output_type -> proto.RunCommandResponse
	3,  // 18: proto.Main.PostInstall:output_type -> proto.PostInstallResponse
	5,  // 19: proto.Main.PreUninstall:output_type -> proto.PreUninstallResponse
	10, // 20: proto.CoreCLIHelper.Echo:output_type -> proto.EchoResponse
	12, // 21: proto.CoreCLIHelper.SendAnalytics:output_type -> proto.SendAnalyticsResponse
	14, // 22: proto.CoreCLIHelper.KeychainGetPassword:output_type -> proto.KeychainGetPasswordResponse
	16, // 23: proto.CoreCLIHelper.KeychainSetPassword:output_type -> proto.KeychainSetPasswordResponse
	18, // 24: proto.CoreCLIHelper.KeychainDeletePassword:output_type -> proto.KeychainDeletePasswordResponse
	20, // 25: proto.CoreCLIHelper.KeychainFindCredentials:output_type -> proto.KeychainFindCredentialsResponse
	22, // 26: proto.CoreCLIHelper.RunPeerPlugin:output_type -> proto.RunPeerPluginResponse
	24, // 27: proto.CoreCLIHelper.ResolveCredentials:output_type -> proto.ResolveCredentialsResponse
	24, // 28: proto.CoreCLIHelper.ResolveCredentialsForAnyMode:output_type -> proto.ResolveCredentialsResponse
