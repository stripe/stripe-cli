...
const (
	LoginHandoffState_LOGIN_HANDOFF_STATE_UNSPECIFIED   LoginHandoffState = 0
	LoginHandoffState_LOGIN_HANDOFF_STATE_PENDING       LoginHandoffState = 1
	LoginHandoffState_LOGIN_HANDOFF_STATE_COMPLETING    LoginHandoffState = 2
	LoginHandoffState_LOGIN_HANDOFF_STATE_AUTHENTICATED LoginHandoffState = 3
	...
	LoginHandoffState_LOGIN_HANDOFF_STATE_SESSION_PRESENT   LoginHandoffState = 4
	LoginHandoffState_LOGIN_HANDOFF_STATE_EXPIRED           LoginHandoffState = 5
	LoginHandoffState_LOGIN_HANDOFF_STATE_DENIED            LoginHandoffState = 6
	LoginHandoffState_LOGIN_HANDOFF_STATE_SUPERSEDED        LoginHandoffState = 7
	LoginHandoffState_LOGIN_HANDOFF_STATE_RECOVERY_REQUIRED LoginHandoffState = 8
)

// Enum value maps for LoginHandoffState.
var (
	LoginHandoffState_name = map[int32]string{
		0: "LOGIN_HANDOFF_STATE_UNSPECIFIED",
		1: "LOGIN_HANDOFF_STATE_PENDING",
		2: "LOGIN_HANDOFF_STATE_COMPLETING",
		3: "LOGIN_HANDOFF_STATE_AUTHENTICATED",
		4: "LOGIN_HANDOFF_STATE_SESSION_PRESENT",
		5: "LOGIN_HANDOFF_STATE_EXPIRED",
		6: "LOGIN_HANDOFF_STATE_DENIED",
		7: "LOGIN_HANDOFF_STATE_SUPERSEDED",
		8: "LOGIN_HANDOFF_STATE_RECOVERY_REQUIRED",
	}
	LoginHandoffState_value = map[string]int32{
...
func (x LoginHandoffState) Enum() *LoginHandoffState {
	p := new(LoginHandoffState)
	*p = x
	return p
}

func (x LoginHandoffState) String() string {
...
func (x *BeginOrResumeLoginRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type LoginHandoffResponse struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	State     LoginHandoffState      `protobuf:"varint,1,opt,name=state,proto3,enum=proto.LoginHandoffState" json:"state,omitempty"`
	...
	BrowserUrl        string                 `protobuf:"bytes,3,opt,name=browser_url,json=browserUrl,proto3" json:"browser_url,omitempty"`
	...
	CheckAfterSeconds int32                  `protobuf:"varint,6,opt,name=check_after_seconds,json=checkAfterSeconds,proto3" json:"check_after_seconds,omitempty"`
...
func (x *LoginHandoffResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *LoginHandoffResponse) GetState() LoginHandoffState {
	...
	return LoginHandoffState_LOGIN_HANDOFF_STATE_UNSPECIFIED
}

func (x *LoginHandoffResponse) GetHandoffId() string {
	if x != nil {
		return x.HandoffId
	}
	return ""
...
func (x *LoginHandoffResponse) GetBrowserUrl() string {
	if x != nil {
		return x.BrowserUrl
	}
	return ""
...
func (x *LoginHandoffResponse) GetVerificationCode() string {
	if x != nil {
...
func (x *LoginHandoffResponse) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
func (x *LoginHandoffResponse) GetCheckAfterSeconds() int32 {
	if x != nil {
		return x.CheckAfterSeconds
	}
	return 0
}

func (x *LoginHandoffResponse) GetReused() bool {
	if x != nil {
		return x.Reused
	}
	return false
...
func (x *LoginHandoffResponse) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
func (x *LoginHandoffResponse) GetLivemode() bool {
	if x != nil {
		return x.Livemode
	}
	return false
...
const file_pkg_plugins_proto_main_proto_rawDesc = "" +
	"\n" +
	"\x1cpkg/plugins/proto/main.proto\x12\x05proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x94\x01\n" +
	...
	"\n" +
	"handoff_id\x18\x01 \x01(\tR\thandoffId\"\xf1\x02\n" +
	"\x14LoginHandoffResponse\x12.\n" +
	"\x05state\x18\x01 \x01(\x0e2\x18.proto.LoginHandoffStateR\x05state\x12\x1d\n" +
	"\n" +
	"handoff_id\x18\x02 \x01(\tR\thandoffId\x12\x1f\n" +
	"\vbrowser_url\x18\x03 \x01(\tR\n" +
	"browserUrl\x12+\n" +
	"\x11verification_code\x18\x04 \x01(\tR\x10verificationCode\x129\n" +
	"\n" +
	"expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt\x12.\n" +
	"\x13check_after_seconds\x18\x06 \x01(\x05R\x11checkAfterSeconds\x12\x16\n" +
	"\x06reused\x18\a \x01(\bR\x06reused\x12\x1d\n" +
	"\n" +
	"account_id\x18\b \x01(\tR\taccountId\x12\x1a\n" +
	"\blivemode\x18\t \x01(\bR\blivemode\"#\n" +
	...
	"\x1eLOGIN_HANDOFF_STATE_COMPLETING\x10\x02\x12%\n" +
	"!LOGIN_HANDOFF_STATE_AUTHENTICATED\x10\x03\x12'\n" +
	"#LOGIN_HANDOFF_STATE_SESSION_PRESENT\x10\x04\x12\x1f\n" +
	"\x1bLOGIN_HANDOFF_STATE_EXPIRED\x10\x05\x12\x1e\n" +
	"\x1aLOGIN_HANDOFF_STATE_DENIED\x10\x06\x12\"\n" +
	"\x1eLOGIN_HANDOFF_STATE_SUPERSEDED\x10\a\x12)\n" +
	"%LOGIN_HANDOFF_STATE_RECOVERY_REQUIRED\x10\b2\xd8\x01\n" +
	"\x04Main\x12A\n" +
	"\n" +
