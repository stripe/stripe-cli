...
type CoreCLIHelperClient interface {
	...
	CheckLogin(ctx context.Context, in *CheckLoginRequest, opts ...grpc.CallOption) (*LoginHandoffResponse, error)
}
...
func (c *coreCLIHelperClient) BeginOrResumeLogin(ctx context.Context, in *BeginOrResumeLoginRequest, opts ...grpc.CallOption) (*LoginHandoffResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoreCLIHelper_BeginOrResumeLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreCLIHelperClient) CheckLogin(ctx context.Context, in *CheckLoginRequest, opts ...grpc.CallOption) (*LoginHandoffResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginHandoffResponse)
	err := c.cc.Invoke(ctx, CoreCLIHelper_CheckLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreCLIHelperServer interface {
	...
	// Check an existing handoff once and durably install credentials on completion.
	// Request cancellation never discards the pending authorization.
	CheckLogin(context.Context, *CheckLoginRequest) (*LoginHandoffResponse, error)
...
func (UnimplementedCoreCLIHelperServer) CheckLogin(context.Context, *CheckLoginRequest) (*LoginHandoffResponse, error) {
...
func _CoreCLIHelper_BeginOrResumeLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(CoreCLIHelperServer).BeginOrResumeLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoreCLIHelper_BeginOrResumeLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreCLIHelperServer).BeginOrResumeLogin(ctx, req.(*BeginOrResumeLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CoreCLIHelper_CheckLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreCLIHelperServer).CheckLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoreCLIHelper_CheckLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreCLIHelperServer).CheckLogin(ctx, req.(*CheckLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CoreCLIHelper_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CoreCLIHelper_BeginOrResumeLogin_Handler,
		},
		{
			MethodName: "CheckLogin",
			Handler:    _CoreCLIHelper_CheckLogin_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/plugins/proto/main.proto",
