...
func TestVerboseTransport(t *testing.T) {
	...
	tr := &verboseTransport{
		...
		Out:              &b,
		PrintableHeaders: append(DefaultPrintableHeaders(), "X-Test-Header"),
	}
	...
	req.Header.Set("X-Test-Header", "custom-value")
	...
	require.Contains(t, out, "> X-Test-Header: custom-value\n")
