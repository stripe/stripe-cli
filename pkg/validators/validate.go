...
var (
	...
	ErrDeviceNameNotConfigured = errorcategory.New(errorcategory.Auth, "you have not configured your device name yet")
	// ErrAccountIDNotConfigured is the error returned when the loaded profile is missing the account_id property
	ErrAccountIDNotConfigured = errorcategory.New(errorcategory.Auth, "you have not configured your accountID yet")
)
