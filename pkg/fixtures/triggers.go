...
// interopEvents is the set of traditional webhook events eligible for delivery
// as thin v1-prefixed events via event destinations.
...
// resolveInteropEvent checks whether event is a v1.-prefixed interop event and, if so,
// returns the fixture path for the corresponding unprefixed event.
