...
var Events = map[string]string{
	...
	"customer.tax_id.updated":                              "triggers/customer.tax_id.updated.json",
	...
	"v2.core.account.closed":                               "triggers/v2.core.account.closed.json",
	"v2.core.account.created":                              "triggers/v2.core.account.created.json",
	"v2.core.account.updated":                              "triggers/v2.core.account.updated.json",
	"v2.core.account[configuration.customer].capability_status_updated":  "triggers/v2.core.account[configuration.customer].capability_status_updated.json",
	"v2.core.account[configuration.customer].updated":                    "triggers/v2.core.account[configuration.customer].updated.json",
	"v2.core.account[configuration.merchant].capability_status_updated":  "triggers/v2.core.account[configuration.merchant].capability_status_updated.json",
	"v2.core.account[configuration.merchant].updated":                    "triggers/v2.core.account[configuration.merchant].updated.json",
	"v2.core.account[configuration.recipient].capability_status_updated": "triggers/v2.core.account[configuration.recipient].capability_status_updated.json",
	"v2.core.account[configuration.recipient].updated":                   "triggers/v2.core.account[configuration.recipient].updated.json",
	"v2.core.account[defaults].updated":                                  "triggers/v2.core.account[defaults].updated.json",
	"v2.core.account[future_requirements].updated":                       "triggers/v2.core.account[future_requirements].updated.json",
	"v2.core.account[identity].updated":                                  "triggers/v2.core.account[identity].updated.json",
	"v2.core.account[requirements].updated":                              "triggers/v2.core.account[requirements].updated.json",
	"v2.core.account_link.returned":                                      "triggers/v2.core.account_link.returned.json",
	"v2.core.account_person.created":                                     "triggers/v2.core.account_person.created.json",
	"v2.core.account_person.deleted":                                     "triggers/v2.core.account_person.deleted.json",
	"v2.reporting.report_run.created":                                    "triggers/v2.reporting.report_run.created.json",
}
