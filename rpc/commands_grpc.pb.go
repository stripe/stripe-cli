...
const (
	StripeCLI_EventsResend_FullMethodName          = "/rpc.StripeCLI/EventsResend"
	StripeCLI_Fixture_FullMethodName               = "/rpc.StripeCLI/Fixture"
	StripeCLI_Listen_FullMethodName                = "/rpc.StripeCLI/Listen"
	...
	StripeCLI_WebhookEndpointCreate_FullMethodName = "/rpc.StripeCLI/WebhookEndpointCreate"
	StripeCLI_WebhookEndpointsList_FullMethodName  = "/rpc.StripeCLI/WebhookEndpointsList"
)
...
func (c *stripeCLIClient) EventsResend(ctx context.Context, in *EventsResendRequest, opts ...grpc.CallOption) (*EventsResendResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_EventsResend_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) Fixture(ctx context.Context, in *FixtureRequest, opts ...grpc.CallOption) (*FixtureResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_Fixture_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) Listen(ctx context.Context, in *ListenRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ListenResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StripeCLI_ServiceDesc.Streams[0], StripeCLI_Listen_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type StripeCLI_ListenClient = grpc.ServerStreamingClient[ListenResponse]

func (c *stripeCLIClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, StripeCLI_Login_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) LoginStatus(ctx context.Context, in *LoginStatusRequest, opts ...grpc.CallOption) (*LoginStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_LoginStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) LogsTail(ctx context.Context, in *LogsTailRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[LogsTailResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StripeCLI_ServiceDesc.Streams[1], StripeCLI_LogsTail_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[LogsTailRequest, LogsTailResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *stripeCLIClient) Trigger(ctx context.Context, in *TriggerRequest, opts ...grpc.CallOption) (*TriggerResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_Trigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) TriggersList(ctx context.Context, in *TriggersListRequest, opts ...grpc.CallOption) (*TriggersListResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_TriggersList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_Version_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) WebhookEndpointCreate(ctx context.Context, in *WebhookEndpointCreateRequest, opts ...grpc.CallOption) (*WebhookEndpointCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_WebhookEndpointCreate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripeCLIClient) WebhookEndpointsList(ctx context.Context, in *WebhookEndpointsListRequest, opts ...grpc.CallOption) (*WebhookEndpointsListResponse, error) {
	...
	err := c.cc.Invoke(ctx, StripeCLI_WebhookEndpointsList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedStripeCLIServer should be embedded to have
...
func (UnimplementedStripeCLIServer) EventsResend(context.Context, *EventsResendRequest) (*EventsResendResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EventsResend not implemented")
}
func (UnimplementedStripeCLIServer) Fixture(context.Context, *FixtureRequest) (*FixtureResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Fixture not implemented")
}
func (UnimplementedStripeCLIServer) Listen(*ListenRequest, grpc.ServerStreamingServer[ListenResponse]) error {
...
func (UnimplementedStripeCLIServer) TriggersList(context.Context, *TriggersListRequest) (*TriggersListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TriggersList not implemented")
}
...
func (UnimplementedStripeCLIServer) WebhookEndpointCreate(context.Context, *WebhookEndpointCreateRequest) (*WebhookEndpointCreateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WebhookEndpointCreate not implemented")
}
func (UnimplementedStripeCLIServer) WebhookEndpointsList(context.Context, *WebhookEndpointsListRequest) (*WebhookEndpointsListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WebhookEndpointsList not implemented")
}
func (UnimplementedStripeCLIServer) testEmbeddedByValue() {}
...
func RegisterStripeCLIServer(s grpc.ServiceRegistrar, srv StripeCLIServer) {
	// If the following call panics, it indicates UnimplementedStripeCLIServer was
...
func _StripeCLI_EventsResend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_EventsResend_FullMethodName,
	}
...
func _StripeCLI_Fixture_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_Fixture_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StripeCLI_Listen_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StripeCLIServer).Listen(m, &grpc.GenericServerStream[ListenRequest, ListenResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StripeCLI_ListenServer = grpc.ServerStreamingServer[ListenResponse]
...
func _StripeCLI_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_Login_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StripeCLI_LoginStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_LoginStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StripeCLI_LogsTail_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StripeCLIServer).LogsTail(m, &grpc.GenericServerStream[LogsTailRequest, LogsTailResponse]{ServerStream: stream})
}
...
func _StripeCLI_Trigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_Trigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StripeCLI_TriggersList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_TriggersList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StripeCLI_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_Version_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StripeCLI_WebhookEndpointCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_WebhookEndpointCreate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StripeCLI_WebhookEndpointsList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StripeCLI_WebhookEndpointsList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
